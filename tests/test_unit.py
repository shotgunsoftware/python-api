...
import shotgun_api3.lib.httplib2  # noqa: E402
...
class TestSocketKeepalive(unittest.TestCase):
    ...
    def test_proxied_socket_enables_keepalive(self):
        sock = mock.MagicMock()
        proxy_info = shotgun_api3.lib.httplib2.ProxyInfo(
            shotgun_api3.lib.httplib2.socks.PROXY_TYPE_HTTP, "proxy.example.com", 8080
        )
        with mock.patch.object(
            shotgun_api3.lib.httplib2.socks, "socksocket", return_value=sock
...
class TestKeepaliveConnectionType(unittest.TestCase):
    ...
    def test_connection_classes_are_httplib2_subclasses(self):
        ...
        self.assertTrue(
            issubclass(
                shotgun.KeepaliveHTTPSConnection,
                shotgun_api3.lib.httplib2.HTTPSConnectionWithTimeout,
            )
        )
        self.assertTrue(
            issubclass(
                shotgun.KeepaliveHTTPConnection,
                shotgun_api3.lib.httplib2.HTTPConnectionWithTimeout,
            )
        )
