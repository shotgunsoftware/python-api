...
class TestShotgunApi(base.LiveTestBase):
    ...
    def test_upload_download(self):
        ...
        s_path = os.path.join(this_dir, 'No\xc3\xabl.jpg')
        u_path = s_path.decode("utf-8")
        ...
        try:
            buffer = b'\xff\xd8\xff\xdb\x00\x84\x00\x01\x01\x01\x01\x01\x01\x01\x01\x01' \
                     b'\x01\x01\x01\x01\x01\x01\x01\x01\x01\x01\x01\x01\x01\x01\x01\x01' \
                     b'\x01\x01\x01\x01\x01\x01\x01\x01\x01\x01\x01\x01\x01\x01\x01\x01' \
                     b'\x01\x01\x02\x02\x02\x02\x02\x02\x02\x02\x02\x02\x02\x03\x03\x03' \
                     b'\x03\x03\x03\x03\x03\x03\x03\x01\x01\x01\x01\x01\x01\x01\x02\x01' \
                     b'\x01\x02\x02\x02\x01\x02\x02\x03\x03\x03\x03\x03\x03\x03\x03\x03' \
                     b'\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03' \
                     b'\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03' \
                     b'\x03\x03\x03\x03\x03\x03\x03\x03\xff\xdd\x00\x04\x00\x01\xff\xee' \
                     b'\x00\x0eAdobe\x00d\xc0\x00\x00\x00\x01\xff\xc0\x00\x11\x08\x00\x02' \
                     b'\x00\x02\x03\x00\x11\x00\x01\x11\x01\x02\x11\x01\xff\xc4\x00J\x00' \
                     b'\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\n' \
                     b'\x01\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00' \
                     b'\x00\x00\x10\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00' \
                     b'\x00\x00\x00\x00\x11\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00' \
                     b'\x00\x00\x00\x00\x00\x00\xff\xda\x00\x0c\x03\x00\x00\x01\x11\x02' \
                     b'\x11\x00?\x00\x7f\x00\xff\xd9'
            fh.write(buffer)
        finally:
            fh.close()
